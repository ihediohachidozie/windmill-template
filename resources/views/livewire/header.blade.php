<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
    <div x-data="{isProfileMenuOpen: @entangle('isProfileMenuOpen'), dark: @entangle('dark'), isNotificationsMenuOpen: @entangle('isNotificationsMenuOpen'), isSideMenuOpen: @entangle('isSideMenuOpen') }">
        <div class="container flex items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
            <!-- Mobile hamburger -->
            <button class="p-1 mr-5 -ml-1 rounded-md md:hidden focus:outline-none focus:shadow-outline-purple" wire:click="$emitTo('body', 'toggleSideMenu')" aria-label="Menu">
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
                <!-- Theme toggler -->
                <li class="flex">
                    <button class="rounded-md focus:outline-none focus:shadow-outline-purple" wire:click="toggleTheme" aria-label="Toggle color mode">
                        <template x-if="!dark">
                ...
                <!-- Notifications menu -->
                <li class="relative">
                    <button class="relative align-middle rounded-md focus:outline-none focus:shadow-outline-purple" wire:click="toggleNotificationsMenu" @keydown.escape="closeNotificationsMenu" aria-label="Notifications" aria-haspopup="true">
                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                ...
                <li class="relative">
                    ...
                    <button class="align-middle rounded-full focus:shadow-outline-purple focus:outline-none" wire:click="toggleProfileMenu" @keydown.escape="closeProfileMenu" aria-label="Account" aria-haspopup="true">
